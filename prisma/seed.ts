  ...
  const projects = [
    {
      title: "Insight-Zero",
      slug: "insight-zero",
      description: "The Autonomous Data Steward. A multi-tenant Enterprise Data Intelligence Platform integrating RBAC and Presidio for SOC2-ready PII redaction.",
      content: `
## Overview
...
- **Reporting:** Developed a multi-modal reporting engine using **React-PDF**, generating executive summaries and interactive dashboards.
    ...
    },
    {
      title: "LocalLens",
      slug: "locallens",
      description: "AI-Powered Demand Forecasting & Inventory Engine. Top 10 Finish in IEEE Gravitas Hackathon.",
      content: `
## Achievement
...
- **DevOps:** Streamlined deployment by containerizing the end-to-end application with **Docker**.
    ...
    },
    {
      title: "Fit Track",
      slug: "fit-track",
      description: "Full-Stack Fitness Coaching Platform built with Next.js 14 and Feature-Sliced Design.",
      content: `
## Architecture
...
- **Backend:** Constructed a type-safe backend with **PostgreSQL** and **Prisma** to ensure data integrity.
      `,
      tags: ["Next.js", "TypeScript", "PostgreSQL", "Docker", "FSD", "Tailwind"],
    ...
    },
    {
      title: "SkillSync",
      slug: "skillsync",
      description: "AI-Powered Career Development Platform generating personalized skill recommendations.",
      content: `
## Core Features
